...
\smallskip
\textbf{Conclusion:} A six-stage multi-view pipeline achieves AUROC=0.8458 on \vindr{}. Bounding-box shortcut learning is a key negative finding; domain generalisation to the \rsna{} dataset remains an open challenge.
\end{tcolorbox}
\smallskip
