...
\begin{tabular}{@{}p{0.21\textwidth} p{0.11\textwidth} p{0.22\textwidth} p{0.06\textwidth} p{0.06\textwidth} p{0.21\textwidth}@{}}
\toprule
...
\bottomrule
\multicolumn{5}{@{}p{0.9\columnwidth}@{}}{\small ---: not evaluated. Differences in AUROC are within the $\pm$0.04 BCa CI; the selective ensemble offers marginal S@90\% benefit.}
\end{tabular}}
\end{table}
